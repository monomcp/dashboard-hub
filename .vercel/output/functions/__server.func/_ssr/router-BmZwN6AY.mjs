...
const appCss = "/assets/styles-DGyJrfqm.css";
...
const $$splitComponentImporter$i = () => import("./terms-CaZVG7wB.mjs");
const Route$k = createFileRoute("/terms")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$h = () => import("./privacy-CznA4xxN.mjs");
...
const $$splitComponentImporter$f = () => import("./mcp-Bom5feLm.mjs");
...
const $$splitComponentImporter$b = () => import("./drive-DvCVnLzs.mjs");
...
const $$splitComponentImporter$7 = () => import("./cms-BhOm7rX0.mjs");
...
const $$splitComponentImporter$3 = () => import("./permissions._toolkitId-C_yUbRkI.mjs");
const Route$3 = createFileRoute("/permissions/$toolkitId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./content._view-CWj84U6e.mjs");
...
const $$splitComponentImporter$1 = () => import("./brand._view-k0vvnQ5F.mjs");
...
const $$splitComponentImporter = () => import("./auth.magic-link.confirm-yDICrmZ4.mjs");
...
const TermsRoute = Route$k.update({
  id: "/terms",
  path: "/terms",

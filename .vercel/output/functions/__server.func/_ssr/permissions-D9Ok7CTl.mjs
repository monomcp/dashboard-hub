...
import { l as lightPermissionsTheme, P as PermissionsMatrixLoading } from "./permissions-matrix-4w0Eu5YN.mjs";
import { a as apiRequest } from "./api-client-CDT_AGSo.mjs";
import { c as cn } from "./utils-H80jjgLf.mjs";
import { M as Menu, K as KeyRound, d as CircleQuestionMark, e as Settings, a as Squircle } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[hsl(220,33%,98%)] text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
      sidebarOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden w-[260px] shrink-0 px-3 md:block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1 px-2 text-xs font-medium uppercase tracking-wide text-muted-foreground", children: "Identities" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "mb-4 space-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/principals", className: "flex w-full items-center gap-3 rounded-full px-3 py-2 text-sm text-foreground/80 transition hover:bg-white/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(KeyRound, { className: "h-5 w-5 shrink-0 text-foreground/70" }),

    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "left", className: "w-80 p-0 sm:max-w-80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "border-b border-border px-6 py-5 text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-xl font-normal", children: "Privacy Policy" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "px-3 py-4", "aria-label": "Legal pages", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/terms", className: "block rounded-xl px-3 py-3 text-sm font-medium text-foreground transition hover:bg-muted", children: "Terms of Service" }) })
        ] })
      ] }),

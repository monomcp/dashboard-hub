...
import { A as AppsMenu, a as AccountMenu, P as PinterestIcon } from "./account-menu-DSoi5KdC.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [
        ...
        data?.map((server) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col rounded-2xl bg-white p-5 ring-1 ring-black/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            server.slug === "pinterest" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-10 w-10 place-items-center rounded-xl bg-white ring-1 ring-black/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PinterestIcon, { className: "h-6 w-6" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-sky-500 to-indigo-600 text-sm font-semibold uppercase text-white", children: server.name.charAt(0) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(EnableMcpServerButton, { serverSlug: server.slug, enabled: server.enabled, toolkitIds: server.toolkit_ids }),
            server.slug === "pinterest" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/pinterest", className: "text-sm font-medium text-[#E60023] hover:underline", children: "Configure →" })
          ] })
        ] }, server.slug))
      ] })
    ] })

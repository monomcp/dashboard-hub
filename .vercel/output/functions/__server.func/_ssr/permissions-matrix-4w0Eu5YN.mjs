...
import { K as KeyRound, b1 as Minus, an as X, b2 as Ban, ac as Clock, b as Check, ai as Bot, aa as User, L as LoaderCircle, O as ChevronDown } from "../_libs/lucide-react.mjs";
...
function GrantControl({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open, onOpenChange: setOpen, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { align: "start", className: cn(theme.menuPanel, "space-y-px"), children: [
...
function PrincipalLabel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("grid h-8 w-8 shrink-0 place-items-center rounded-full", theme.avatarBg), children: /* @__PURE__ */ jsxRuntimeExports.jsx(PIcon, { className: cn("h-4 w-4", theme.principalIcon) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("mt-0.5 flex items-center gap-1.5 text-xs", theme.principalSub), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: meta.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GrantControl, { principal, busy, onSet, onRevoke })
      ] })
    ] })
  ] });
}
function PermissionsMatrix({
  ...
  const [orientation, setOrientation] = reactExports.useState("principals");
  const moduleScope = reactExports.useMemo(
    () => [...new Set(moduleSlugs ?? [])].filter(Boolean).sort(),
    [moduleSlugs]
  );
  const toolkitMatrixQueryKey = reactExports.useMemo(
    () => ["toolkit-access-matrix", toolkitId],
    [toolkitId]
  );
  const matrixQueryKey = reactExports.useMemo(
    () => [...toolkitMatrixQueryKey, moduleScope.join(",")],
    [toolkitMatrixQueryKey, moduleScope]
  );
  const matrixPath = reactExports.useMemo(() => {
    if (!toolkitId) return "";
  ...
  const toolkitNames = reactExports.useMemo(() => {
  ...
  const toolLabel = (tool) => stripToolPrefix ? tool.name.replace(stripToolPrefix, "") : tool.name;
  const renderToolCell = (principal, tool) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ToolAccessCell,
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: theme, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid content-start gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
        ...
        toolkitIds.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            children: toolkitIds.map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: id, children: data && data.toolkit_id === id ? data.toolkit_name : toolkitNames.get(id) ?? id.slice(0, 8) }, id))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: [
          ...
          "button",
          {
            ...
            title: opt.id === "principals" ? "Principals as rows, tools as columns" : "Tools as rows, principals as columns",
            className: cn(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("overflow-x-auto rounded-3xl", theme.tableWrap), children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { className: "w-full border-collapse text-sm", children: orientation === "principals" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: cn("text-xs uppercase tracking-wide", theme.thead), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        ...
        tools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "th",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block max-w-[120px] truncate normal-case", children: toolLabel(tool) })
          },
          tool.id
        ))
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        principals.map((principal) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: cn("border-t", theme.rowBorder), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cn("sticky left-0 z-10 px-4 py-3", theme.bodyStickyBg), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            PrincipalLabel,
            {
              principal,
          ...
          tools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: renderToolCell(principal, tool) }, tool.id))
        ] }, principal.id)),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: cn("text-xs uppercase tracking-wide", theme.thead), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        ...
        principals.map((principal) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "th",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        principals.length > 0 && tools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: cn("border-t", theme.rowBorder), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "td",
            {
          ...
          principals.map((principal) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: renderToolCell(principal, tool) }, principal.id))
        ] }, tool.id)),
        (principals.length === 0 || tools.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "td",
          {
            colSpan: principals.length + 1,
            className: cn("px-4 py-10 text-center", theme.emptyText),
            children: principals.length === 0 ? onlyWithAccess ? "No principal has access to these tools yet." : "No principals in this organization yet." : "No tools in this toolkit yet."
          }
        ) })
      ] })
    ] }) }) })
...
export {
  PermissionsMatrixLoading as P,
  PermissionsMatrix as a,

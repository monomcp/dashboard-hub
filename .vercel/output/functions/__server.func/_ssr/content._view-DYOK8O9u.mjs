...
import { u as useQuery, a as useQueryClient, c as useInfiniteQuery } from "../_libs/tanstack__react-query.mjs";
...
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, e as DialogFooter } from "./dialog-CypSg8M2.mjs";
...
import { c as Route$2 } from "./router-Dn9BFNaf.mjs";
import { aF as Lightbulb, as as CalendarDays, aG as Compass, a7 as LayoutGrid, K as KeyRound, j as Activity, a0 as List, M as Menu, al as PenLine, l as Search, d as CircleQuestionMark, e as Settings, ap as Hash, G as Globe, aH as Linkedin, aI as Twitter, aJ as Youtube, aK as Facebook, aL as Instagram, k as SlidersHorizontal, an as X, aM as AtSign, P as Plus, x as Star, b as Check, aN as ThumbsDown, aO as CalendarPlus, T as Trash2, L as LoaderCircle, V as FileText, E as EllipsisVertical, at as ChevronLeft, s as Pencil, az as CalendarClock, aP as History, aa as User, ai as Bot, aE as Plug, aw as MousePointerClick, Y as ChevronRight, aQ as Undo2 } from "../_libs/lucide-react.mjs";
...
function ContentIdeasBoard({ brandId, query, onError }) {
...
function ContentCalendarList({ brandId, view = "list", onError }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Select,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-9 w-[180px] rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All statuses" }),
            CALENDAR_STATUSES.map((status) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: status, children: statusLabel$1(status) }, status))
          ] })
        ]
      }
    ) }),
      ...
      items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "li",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusPill$1, { status: item.status }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick: (e) => e.stopPropagation(), className: "hidden justify-end md:flex", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuContent, { align: "end", className: "w-36 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                DropdownMenuItem,
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "rounded-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete calendar item?" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { disabled: mutating, className: "rounded-lg", children: "No" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              AlertDialogAction,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: selected !== null, onOpenChange: (open) => !open && closeDetail(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SheetContent,
      {
        side: "right",
        ...
        children: selected && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "border-b px-6 py-5 text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 grid h-8 w-8 shrink-0 place-items-center rounded-full bg-[hsl(220,33%,95%)] text-foreground/70", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-4 w-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "truncate text-xl", children: selected.title || "Untitled" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetDescription, { className: "mt-1 truncate text-base", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center gap-2 border-b px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: CALENDAR_STATUSES.map((status) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: status, children: statusLabel$1(status) }, status)) })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-6 py-5", children: detailLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ContentItemDetailSkeleton, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "briefs", children: [
...
function ContentItemDetailSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-black/5 px-3 py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-64 max-w-full" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-20 rounded-full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "mt-3 h-4 w-80 max-w-full" }),
...
function ContentStrategyPanel({ brandId, onError }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-black/5 p-4", children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No content strategy yet for this brand." })
    ] }),
...
const EMPTY_SCORES = Object.fromEntries(SOCIAL_SCORE_FIELDS.map(([key]) => [key, ""]));
function SocialIdeasBoard({ brandId, platformId, platforms, query, onError }) {
  const [ideas, setIdeas] = reactExports.useState([]);
  const [pillars, setPillars] = reactExports.useState([]);
  const [tab, setTab] = reactExports.useState("all");
  const [loading, setLoading] = reactExports.useState(true);
  ...
  const deleteIdea = async (ideaId) => {
    setMutating(true);
    try {
      await apiRequest(`/api/v1/social/ideas/${ideaId}`, {
        method: "DELETE"
      });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    !loading && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid gap-2", children: ideas.map((idea) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        className: "rounded-xl border border-black/5 px-3 py-3 text-sm transition hover:bg-[hsl(220,33%,97%)]",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2 sm:grid-cols-[minmax(0,1fr)_minmax(13rem,max-content)] sm:items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: idea.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-52 shrink-0 justify-end gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-36", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => openScore(idea), children: [
...
function SocialDraftEditor({ briefId, onError }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-2 py-2", children: [1, 2].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-xl" }, item)) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
...
function SocialBriefDetail({
  ...
  const openReviews = async (brief) => {
    ...
    try {
      setReviews(
        await apiRequest(`/api/v1/social/briefs/${brief.id}/reviews`)
      );
    } catch (err) {
      onError(err);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-28 rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          variant: "outline",
          size: "sm",
    ...
    loading && /* @__PURE__ */ jsxRuntimeExports.jsx(SocialBriefDetailSkeleton, {}),
    !loading && briefs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No briefs for this calendar item yet." }),
    !loading && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid gap-2", children: briefs.map((brief) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-xl border border-black/5 px-3 py-3 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-36 rounded-xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { className: "gap-2", onClick: () => openReviews(brief), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex shrink-0 flex-wrap items-center gap-1", children: [
        brief.status !== "approved" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-xs text-muted-foreground", children: [brief.objective, brief.audience].filter(Boolean).join(" · ") || "No objective set" }),
...
function SocialBriefDetailSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-black/5 px-3 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-80 max-w-full" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-11/12" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-2/3" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "mt-4 h-4 w-72 max-w-full" })
  ] });
}
const PLATFORM_ICONS$1 = {
  instagram: Instagram,
  facebook: Facebook,
  youtube: Youtube,
  x: Twitter,
...
function SocialCalendarList({
  ...
  const [selected, setSelected] = reactExports.useState(null);
  const [briefs, setBriefs] = reactExports.useState([]);
  const [briefsLoading, setBriefsLoading] = reactExports.useState(false);
  ...
  const SelectedPlatformIcon = selectedPlatformSlug ? PLATFORM_ICONS$1[selectedPlatformSlug] ?? Hash : Hash;
  const load = reactExports.useCallback(async () => {
    setLoading(true);
    try {
      const params = new URLSearchParams({ brand_id: brandId, limit: "100" });
  ...
  reactExports.useEffect(() => {
    ...
    void (async () => {
      try {
        const item = itemFromList ?? await apiRequest(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Select,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All statuses" }),
            SOCIAL_CALENDAR_STATUSES.map((status) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: status, children: statusLabel$1(status) }, status))
          ] })
        ]
      }
    ) }),
    ...
    !loading && items.length > 0 && view === "list" && /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { children: [
      ...
      items.map((item) => {
        ...
        const ItemPlatformIcon = itemPlatformSlug ? PLATFORM_ICONS$1[itemPlatformSlug] ?? Hash : Hash;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "li",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ItemPlatformIcon, { className: "h-4 w-4" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate font-medium", children: item.title || "Untitled" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusPill, { status: item.status }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: selected !== null, onOpenChange: (open) => !open && closeDetail(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SheetContent,
      {
        ...
        children: selected && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "border-b px-6 py-5 text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-start gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectedPlatformIcon, { className: "h-4 w-4" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "truncate text-xl", children: selected.title || "Untitled" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 border-b px-6 py-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatusPill, { status: selected.status, className: "h-9 rounded-lg" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-6 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            SocialBriefDetail,
            {
              calendarItemId: selected.id,
              briefs,
...
function SocialStrategyPanel({ brandId, onError }) {
  const [strategy, setStrategy] = reactExports.useState(null);
  const [loading, setLoading] = reactExports.useState(true);
  const [mutating, setMutating] = reactExports.useState(false);
  const [dialogOpen, setDialogOpen] = reactExports.useState(false);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-black/5 p-4", children: [
      ...
      strategy ? /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "grid gap-3 text-sm sm:grid-cols-2", children: [
        LIST_FIELDS.map(([key, label]) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-xs font-medium uppercase tracking-wide text-muted-foreground", children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: items.length ? items.map((item) => typeof item === "string" ? item : JSON.stringify(item)).join(", ") : "—" })
          ] }, key);
        }),
...
const MODE_CONFIG = {
  content: {
    serverSlug: "content",
    toolsNoun: "Content",
    disabledHint: "Who can use the Content tools, and how. Enable the Content MCP server first to start granting access.",
    connectHint: "No Content toolkit is connected yet — enable the Content MCP server from the MCP catalog."
  },
  social: {
    serverSlug: "smm",
    toolsNoun: "Social content",
    disabledHint: "Who can use the Social content tools, and how. Enable the Social (SMM) MCP server first to start granting access.",
    connectHint: "No Social content toolkit is connected yet — enable the Social MCP server from the MCP catalog."
  }
};
...
function activityRequestPath(filters, offset, scope) {
  const params = new URLSearchParams({
...
function isContentLog(log, mode) {
  if (mode === "social") {
...
function ContentActivityView({
  ...
  const activityScope = reactExports.useMemo(() => {
    const moduleSlug = mode === "social" ? "smm" : "content";
    const toolkitIds = /* @__PURE__ */ new Set();
  ...
  const allLogs = reactExports.useMemo(
    () => (data?.pages.flatMap((page) => page.items) ?? []).filter((log) => isContentLog(log, mode)).sort((a, b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime()),
    [data, mode]
  );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(card, "flex min-h-28 items-end justify-between gap-4"), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "self-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: cn("mt-2", mutedText), children: [
          "Every ",
          mode === "social" ? "social" : "content",
          " change made through Console and via MCP tool calls."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
...
function ContentPage() {
  ...
  const [mode, setMode] = reactExports.useState(() => searchMode ?? (localStorage.getItem(MODE_STORAGE_KEY) === "social" ? "social" : "content"));
  const [platforms, setPlatforms] = reactExports.useState([]);
  const [platformId, setPlatformId] = reactExports.useState("");
  const [brandId, setBrandId] = reactExports.useState("");
  ...
  reactExports.useEffect(() => {
    void (async () => {
      try {
        const brand = await apiRequest("/api/v1/brand/profile").catch((err) => {
  ...
  const setSelectedSocialCalendarItem = reactExports.useCallback((itemId) => {
    void navigate({
      to: "/content/$view",
      params: {
        view: "calendar"
  ...
  const modeToggle = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative grid overflow-hidden rounded-full bg-[hsl(220,33%,95%)] p-1", style: {
    gridTemplateColumns: `repeat(${CONTENT_MODE_TABS.length}, minmax(0, 1fr))`
  }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true", className: "absolute inset-y-1 left-1 rounded-full bg-white shadow-sm transition-transform duration-300 ease-out", style: {
      width: `calc((100% - 8px) / ${CONTENT_MODE_TABS.length})`,
      transform: `translateX(${Math.max(0, CONTENT_MODE_TABS.findIndex((tab) => tab.id === mode)) * 100}%)`
    } }),
    CONTENT_MODE_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => {
      if (!tab.disabled) selectMode(tab.id);
    }, "aria-disabled": tab.disabled || void 0, disabled: tab.disabled, className: cn("relative z-10 flex items-center justify-center gap-1.5 rounded-full px-5 py-1.5 text-sm transition-colors duration-200", mode === tab.id ? "text-foreground" : "text-foreground/60 hover:text-foreground", tab.disabled && "cursor-not-allowed hover:text-foreground/60"), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tab.label }),
      tab.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-white/80 px-1.5 py-0.5 text-[10px] font-medium leading-none text-foreground/50 shadow-sm", children: tab.badge })
    ] }, tab.id))
  ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[hsl(220,33%,98%)] text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
      sidebarOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden w-[260px] shrink-0 px-3 md:block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "space-y-1", children: CONTENT_NAV.filter((n) => mode === "social" || !n.socialOnly).map((n) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: cn("min-w-0 flex-1 px-4 pb-16 md:pr-6", sidebarOpen ? "md:pl-0" : "md:pl-6"), children: [
        ...
        section === "permissions" && /* @__PURE__ */ jsxRuntimeExports.jsx(ContentPermissionsView, { mode, onApiError: handleApiError }),
        section === "activity" && /* @__PURE__ */ jsxRuntimeExports.jsx(ContentActivityView, { mode, onApiError: handleApiError }),
        !isToolkitSection && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl bg-white p-4 shadow-sm ring-1 ring-black/5 sm:p-6", children: [
          ...
          !loadingBusinesses && mode === "content" && !brandId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid place-items-center rounded-2xl border border-dashed border-black/10 py-16 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "No brand profile yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Create a brand profile first, then plan its content here." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", className: "mt-3 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/brand", children: "Go to Brand" }) })
          ] }),
          !loadingBusinesses && mode === "social" && !brandId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid place-items-center rounded-2xl border border-dashed border-black/10 py-16 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "No brand profile yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Create a brand profile first, then plan its social content here." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", className: "mt-3 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/brand", children: "Go to Brand" }) })
          ] }),
          !loadingBusinesses && brandId && isTemplatesSection && /* @__PURE__ */ jsxRuntimeExports.jsx(SocialTemplateGallery, {}),
          !loadingBusinesses && brandId && mode === "content" && section === "ideas" && /* @__PURE__ */ jsxRuntimeExports.jsx(ContentIdeasBoard, { brandId, query, onError: handleApiError }, brandId),
          !loadingBusinesses && brandId && mode === "content" && section === "calendar" && /* @__PURE__ */ jsxRuntimeExports.jsx(ContentCalendarList, { brandId, view: calendarView, onError: handleApiError }, brandId),
          !loadingBusinesses && brandId && mode === "content" && section === "strategy" && /* @__PURE__ */ jsxRuntimeExports.jsx(ContentStrategyPanel, { brandId, onError: handleApiError }, brandId),
          !loadingBusinesses && brandId && mode === "social" && !isTemplatesSection && section === "ideas" && /* @__PURE__ */ jsxRuntimeExports.jsx(SocialIdeasBoard, { brandId, platformId, platforms, query, onError: handleApiError }, `${brandId}:${platformId}`),
          !loadingBusinesses && brandId && mode === "social" && !isTemplatesSection && section === "calendar" && /* @__PURE__ */ jsxRuntimeExports.jsx(SocialCalendarList, { brandId, platformId, platforms, view: calendarView, selectedItemId: calendarItem, onSelectedItemChange: setSelectedSocialCalendarItem, onError: handleApiError }, `${brandId}:${platformId}`),
          !loadingBusinesses && brandId && mode === "social" && !isTemplatesSection && section === "strategy" && /* @__PURE__ */ jsxRuntimeExports.jsx(SocialStrategyPanel, { brandId, onError: handleApiError }, brandId)
        ] })
      ] })
    ] })
  ] });

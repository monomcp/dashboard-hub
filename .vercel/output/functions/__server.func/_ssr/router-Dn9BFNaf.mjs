...
const appCss = "/assets/styles-BXSHMNbd.css";
...
const $$splitComponentImporter$k = () => import("./terms-CXKP0Tix.mjs");
...
const $$splitComponentImporter$j = () => import("./privacy-CNKD-vGn.mjs");
...
const $$splitComponentImporter$i = () => import("./principals-R-qGrlVM.mjs");
const Route$l = createFileRoute("/principals")({
  head: () => ({
    meta: [{
      title: "Principals"
    }, {
...
const Route$k = createFileRoute("/pinterest")({
  beforeLoad: ({ location }) => {
...
const $$splitComponentImporter$h = () => import("./permissions-D9Ok7CTl.mjs");
const Route$j = createFileRoute("/permissions")({
  head: () => ({
    meta: [{
      title: "Permissions"
    }, {
...
const $$splitComponentImporter$g = () => import("./mcp-BkTBN36-.mjs");
const Route$i = createFileRoute("/mcp")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$f = () => import("./login-DYjp2ojo.mjs");
...
const $$splitComponentImporter$e = () => import("./firecrawl-Cde5_oXn.mjs");
const Route$g = createFileRoute("/firecrawl")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$d = () => import("./email-DWflhWPy.mjs");
const Route$f = createFileRoute("/email")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./drive-Bu5KscLF.mjs");
const Route$e = createFileRoute("/drive")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$b = () => import("./database-B8D8GZHT.mjs");
const Route$d = createFileRoute("/database")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$a = () => import("./contacts-BRrdp1Sk.mjs");
const Route$b = createFileRoute("/contacts")({
  head: () => ({
    meta: [{
      title: "Contacts — CRM"
    }, {
...
const $$splitComponentImporter$9 = () => import("./company-BgHUCs5e.mjs");
const Route$a = createFileRoute("/company")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$8 = () => import("./cms-DImY-0pE.mjs");
const Route$9 = createFileRoute("/cms")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./calendar-MX8szxUe.mjs");
const Route$8 = createFileRoute("/calendar")({
  head: () => ({
    meta: [{
      title: "Calendar"
    }, {
...
const $$splitComponentImporter$6 = () => import("./audit-C_tmxkRa.mjs");
...
const $$splitComponentImporter$5 = () => import("./index-C518SRFm.mjs");
...
const Route$5 = createFileRoute("/brand/")({
  beforeLoad: () => {
    throw redirect({ to: "/brand/$view", params: { view: "dna" }, replace: true });
  }
});
const $$splitComponentImporter$4 = () => import("./pinterest._view-DL_XU6G0.mjs");
const PINTEREST_VIEWS = ["settings", "permissions", "activity"];
function isPinterestView(value) {
  return PINTEREST_VIEWS.includes(value);
}
const Route$4 = createFileRoute("/pinterest/$view")({
  beforeLoad: ({
    params
  }) => {
  ...
  head: ({
    ...
    links: [{
      rel: "canonical",
      href: `/pinterest/${params.view}`
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./permissions._toolkitId-BX9nBjtk.mjs");
const Route$3 = createFileRoute("/permissions/$toolkitId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./content._view-DYOK8O9u.mjs");
const CONTENT_SECTIONS = ["ideas", "calendar", "strategy", "templates", "permissions", "activity"];
...
const Route$2 = createFileRoute("/content/$view")({
  ...
  validateSearch: (search) => ({
    mode: search.mode === "content" || search.mode === "social" ? search.mode : void 0,
    calendarItem: typeof search.calendarItem === "string" && search.calendarItem ? search.calendarItem : void 0
  }),
  head: ({
    params
  }) => ({
...
const $$splitComponentImporter$1 = () => import("./brand._view-DbnsDGdx.mjs");
...
const $$splitComponentImporter = () => import("./auth.magic-link.confirm-CieMALbv.mjs");
...
const PrincipalsRoute = Route$l.update({
  id: "/principals",
  path: "/principals",
  getParentRoute: () => Route$o
});
const PinterestRoute = Route$k.update({
  id: "/pinterest",
  path: "/pinterest",
  getParentRoute: () => Route$o
});
const PermissionsRoute = Route$j.update({
  id: "/permissions",
  path: "/permissions",
  getParentRoute: () => Route$o
});
const McpRoute = Route$i.update({
  id: "/mcp",
  path: "/mcp",
  getParentRoute: () => Route$o
});
...
const FirecrawlRoute = Route$g.update({
  id: "/firecrawl",
  path: "/firecrawl",
  getParentRoute: () => Route$o
});
const EmailRoute = Route$f.update({
  id: "/email",
  path: "/email",
  getParentRoute: () => Route$o
});
const DriveRoute = Route$e.update({
  id: "/drive",
  path: "/drive",
  getParentRoute: () => Route$o
});
const DatabaseRoute = Route$d.update({
  id: "/database",
  path: "/database",
  getParentRoute: () => Route$o
});
...
const ContactsRoute = Route$b.update({
  id: "/contacts",
  path: "/contacts",
  getParentRoute: () => Route$o
});
const CompanyRoute = Route$a.update({
  id: "/company",
  path: "/company",
  getParentRoute: () => Route$o
});
const CmsRoute = Route$9.update({
  id: "/cms",
  path: "/cms",
  getParentRoute: () => Route$o
});
const CalendarRoute = Route$8.update({
  id: "/calendar",
  path: "/calendar",
  getParentRoute: () => Route$o
});
...
const BrandIndexRoute = Route$5.update({
  id: "/brand/",
  path: "/brand/",
  getParentRoute: () => Route$o
});
const PinterestViewRoute = Route$4.update({
  id: "/$view",
  path: "/$view",

...
import { A as AlertDialog, a as AlertDialogTrigger, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-DpCH8EKh.mjs";
import { A as AppsMenu, a as AccountMenu } from "./account-menu-DmhbdlCS.mjs";
import { M as Menu, a0 as Database, f as Search, g as CircleQuestionMark, h as Settings, z as Plus, s as Star, a1 as EyeOff, a2 as Funnel, a3 as LayoutGrid, a4 as ArrowDownUp, a5 as Share2, v as Trash2, a6 as Check } from "../_libs/lucide-react.mjs";
...
function DatabasePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[hsl(220,33%,98%)] text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-w-0 flex-1 px-4 pb-16 md:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [

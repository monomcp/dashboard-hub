...
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, e as DropdownMenuLabel, c as DropdownMenuItem, d as DropdownMenuSeparator } from "./dropdown-menu-IlWUHGwh.mjs";
...
import { M as Menu, m as CircleCheck, f as Search, g as CircleQuestionMark, z as Plus, s as Star, C as ChevronUp, ar as SquareCheckBig, i as EllipsisVertical, a6 as Check, au as Circle, av as CircleCheckBig, ab as LoaderCircle, al as X, a9 as Clock, aw as TextAlignStart, ax as ListChecks } from "../_libs/lucide-react.mjs";
...
function TasksPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[hsl(220,33%,98%)] text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: taskDialogOpen, onOpenChange: setTaskDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "rounded-2xl sm:max-w-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTaskDialogOpen(false), className: "absolute right-4 top-4 rounded-full p-1 hover:bg-stone-100", "aria-label": "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: taskDate, onChange: (e) => setTaskDate(e.target.value), className: "bg-stone-100 border-0 rounded-lg" }),

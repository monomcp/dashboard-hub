...
import { M as Menu, a4 as Database, l as Search, d as CircleQuestionMark, e as Settings, P as Plus, af as Layers, V as FileText, ag as GitBranch, O as ChevronDown, ah as Map$1, ai as Bot, h as Sparkles, aj as FileStack, ak as ListTree, K as KeyRound, j as Activity, L as LoaderCircle, E as EllipsisVertical, al as PenLine, T as Trash2, y as ArrowLeft, a6 as Funnel, b as Check, am as Eye, an as X, R as RefreshCw, Y as ChevronRight, ao as GripVertical, s as Pencil, c as Copy, ap as Hash, W as Image, aq as Link2, ar as Type } from "../_libs/lucide-react.mjs";
...
function applyOrder(nodes, orderedIds) {
...
function reorderTree(nodes, parentId, orderedIds) {
  if (parentId === null) return applyOrder(nodes, orderedIds);
  return nodes.map(
    (node) => node.id === parentId ? { ...node, children: applyOrder(node.children, orderedIds) } : { ...node, children: reorderTree(node.children, parentId, orderedIds) }
  );
}
const EMPTY_DRAFT = {
  label: "",
...
function NavigationView({
  ...
  const [loadingMenus, setLoadingMenus] = reactExports.useState(true);
  const [selectedMenuId, setSelectedMenuId] = reactExports.useState(null);
  const [tree, setTree] = reactExports.useState(null);
  const [loadingTree, setLoadingTree] = reactExports.useState(false);
  const [createMenuOpen, setCreateMenuOpen] = reactExports.useState(false);
  const [menuKey, setMenuKey] = reactExports.useState("");
  const [menuName, setMenuName] = reactExports.useState("");
  const [menuLocale, setMenuLocale] = reactExports.useState("");
  const [savingMenu, setSavingMenu] = reactExports.useState(false);
  const [pendingMenuDelete, setPendingMenuDelete] = reactExports.useState(null);
  ...
  const [pendingItemDelete, setPendingItemDelete] = reactExports.useState(null);
  const [dragId, setDragId] = reactExports.useState(null);
  const [dragOverId, setDragOverId] = reactExports.useState(null);
  const loadMenus = reactExports.useCallback(async () => {
  ...
  const loadTree = reactExports.useCallback(
    async (menuId) => {
      setLoadingTree(true);
      try {
  ...
  const createMenu = async () => {
    ...
    setSavingMenu(true);
    try {
      const next = await apiRequest("/api/v1/cms/navigation-menus", {
        method: "POST",
        body: JSON.stringify({
          key,
          name,
  ...
  const deleteMenu = async () => {
    ...
    try {
      await apiRequest(`/api/v1/cms/navigation-menus/${pendingMenuDelete.id}`, {
        method: "DELETE"
      });
  ...
  const reorderItems = async (target) => {
    ...
    const orderedIds = items.filter((item) => (item.parent_id ?? null) === parentId && item.id !== dragged.id).map((item) => item.id);
    ...
    try {
      await Promise.all(
        orderedIds.map(
          (id, index) => apiRequest(`/api/v1/cms/navigation-items/${id}`, {
            method: "PATCH",
  ...
  const saveItem = async () => {
    ...
    try {
      if (editingItem) {
        await apiRequest(`/api/v1/cms/navigation-items/${editingItem.id}`, {
          method: "PATCH",
  ...
  const deleteItem = async () => {
    ...
    try {
      await apiRequest(`/api/v1/cms/navigation-items/${pendingItemDelete.id}`, {
        method: "DELETE"
      });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-semibold tracking-tight", children: "Navigation" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-muted-foreground", children: "Manage header and footer menus delivered to the website via the CMS API." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "rounded-lg bg-indigo-600 hover:bg-indigo-700", onClick: openCreateMenu, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-1.5 h-4 w-4" }),
        " Create menu"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-[260px_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 rounded-2xl bg-white p-2 shadow-sm ring-1 ring-black/5", children: loadingMenus ? Array.from({ length: 3 }).map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full rounded-lg" }, index)) : menus.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-3 py-6 text-center text-sm text-muted-foreground", children: "No menus yet." }) : menus.map((menu) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: cn(
              ...
              isActive ? "bg-indigo-50 font-semibold text-indigo-700" : "text-foreground/80 hover:bg-slate-50"
            ),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-0 truncate text-left", children: [
                menu.name,
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1.5 font-mono text-xs text-muted-foreground", children: [
                  menu.key,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: selectedMenuId && tree ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "truncate text-lg font-semibold", children: tree.menu.name }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "rounded-lg", onClick: openCreateItem, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-1.5 h-4 w-4" }),
              " Add item"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5", children: loadingTree ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 p-4", children: Array.from({ length: 3 }).map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full rounded-lg" }, index)) }) : items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-6 py-10 text-center text-sm text-muted-foreground", children: "No items in this menu yet. Add one to get started." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-slate-100", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "li",
          {
            draggable: true,
            onDragStart: (event) => {
            ...
            onDragOver: (event) => {
              if (dragId && dragId !== item.id && (items.find((i) => i.id === dragId)?.parent_id ?? null) === (item.parent_id ?? null)) {
            ...
            className: cn(
              ...
              dragId === item.id ? "opacity-50" : dragOverId === item.id ? "bg-indigo-50/70" : "hover:bg-slate-50/60"
            ),
            style: { paddingLeft: 16 + item.depth * 20 },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "h-4 w-4 shrink-0 cursor-grab text-slate-300 active:cursor-grabbing" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm font-medium", children: item.label }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "icon", className: "h-8 w-8 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(EllipsisVertical, { className: "h-4 w-4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Item actions" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-36", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => openEditItem(item), children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl bg-white px-6 py-16 text-center text-sm text-muted-foreground shadow-sm ring-1 ring-black/5", children: loadingMenus ? "Loading…" : "Select a menu or create one to manage its items." }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: createMenuOpen, onOpenChange: setCreateMenuOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Create navigation menu" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { children: [
          "Use a stable key (e.g. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "main-header" }),
          ") — the website fetches the menu by this key."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "menu-key", children: "Key" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "menu-key",
          ...
          menuKey && !MENU_KEY_PATTERN.test(menuKey.trim()) ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-rose-600", children: "Lowercase letters, numbers, hyphens and underscores only." }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "menu-name", children: "Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "menu-name",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "menu-locale", children: "Locale (optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "menu-locale",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setCreateMenuOpen(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            onClick: createMenu,
            children: [
              savingMenu ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-1.5 h-4 w-4 animate-spin" }) : null,
              "Create"
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: itemDialogOpen, onOpenChange: setItemDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editingItem ? "Edit item" : "Add item" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "item-label", children: "Label" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "item-label",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "item-url", children: "URL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "item-url",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "item-navid", children: "navId (active highlight)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "item-navid",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "item-order", children: "Order" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "item-order",
              ...
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "_self", children: "Same tab (_self)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "_blank", children: "New tab (_blank)" })
                  ] })
                ]
              }
            )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                onValueChange: (value) => setDraft((d) => ({ ...d, parentId: value === "none" ? "" : value })),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "None (top level)" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "none", children: "None (top level)" }),
                    parentOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: option.id, children: option.label }, option.id))
                  ] })
                ]
              }
            )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setItemDialogOpen(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            className: "bg-indigo-600 hover:bg-indigo-700",
            ...
            onClick: saveItem,
            children: [
              savingItem ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-1.5 h-4 w-4 animate-spin" }) : null,
      ...
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete this menu?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              "“",
              pendingMenuDelete?.name,
              "” and all of its items will be permanently removed. The website will fall back to its static links."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { className: "bg-rose-600 hover:bg-rose-700", onClick: deleteMenu, children: "Delete" })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete this item?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              "“",
              pendingItemDelete?.label,
              "” will be removed from the menu."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { className: "bg-rose-600 hover:bg-rose-700", onClick: deleteItem, children: "Delete" })
          ] })
        ] })
      }
    )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
      sidebarOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden w-[280px] shrink-0 px-3 md:block", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "space-y-5", children: [
          ...
          !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground", children: "Navigation" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
              setView({
                kind: "navigation"
              });
              setSelected([]);
            }, className: cn("flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-sm transition", view.kind === "navigation" ? "bg-indigo-50 font-semibold text-indigo-700" : "text-foreground/80 hover:bg-white/60"), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ListTree, { className: cn("h-4 w-4", view.kind === "navigation" ? "text-indigo-600" : "text-muted-foreground") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-left", children: "Menus" })
            ] })
          ] }),
          !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: cn("min-w-0 flex-1 px-4 pb-16 md:pr-6", sidebarOpen ? "md:pl-0" : "md:pl-6"), children: [
        ...
        !loading && view.kind === "navigation" && /* @__PURE__ */ jsxRuntimeExports.jsx(NavigationView, { onError: handleApiError }),
...
function EntriesView({
  ...
  const [creating, setCreating] = reactExports.useState(false);
  const [pendingDelete, setPendingDelete] = reactExports.useState(null);
  const [mutatingEntryId, setMutatingEntryId] = reactExports.useState(null);
  ...
  const unpublishEntry = async (entry) => {
    ...
    try {
      await apiRequest(`/api/v1/cms/entry-locales/${entry.primaryLocale.id}/unpublish`, {
        method: "POST"
      });
      await loadEntries();
    } catch (err) {
  ...
  const confirmDeleteEntry = async () => {
    ...
    setMutatingEntryId(entry.id);
    try {
      await apiRequest(`/api/v1/cms/entries/${entry.id}`, {
        method: "DELETE"
      });
      setPendingDelete(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5", children: [
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(EntriesTableSkeleton, {}) : entries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-6 text-sm text-muted-foreground", children: "No entries found." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: entries.map((e) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "grid cursor-pointer grid-cols-[40px_80px_1fr_2fr_140px_120px_40px] items-center gap-4 border-b border-black/5 px-6 py-4 text-sm last:border-b-0 hover:bg-[hsl(220,33%,98%)]", onClick: () => onOpenEntry(e.id), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("rounded-md px-2.5 py-1 text-xs font-medium", statusClass(status)), children: formatStatus(status) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick: (ev) => ev.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "h-8 w-8 rounded-full", "aria-label": "More", disabled: isMutating, children: isMutating ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EllipsisVertical, { className: "h-4 w-4" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-40 rounded-xl", children: [
              isPublished ? /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onSelect: (event) => {
                event.preventDefault();
                void unpublishEntry(e);
              }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FileStack, { className: "mr-2 h-4 w-4" }),
                "Unpublish"
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onSelect: () => onOpenEntry(e.id), children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "mr-2 h-4 w-4" }),
                "Edit"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { className: "text-rose-600 focus:text-rose-600", onSelect: (event) => {
                event.preventDefault();
                setPendingDelete(e);
              }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "mr-2 h-4 w-4" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!pendingDelete, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete entry" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
          "Are you sure you want to delete",
          pendingDelete ? ` "${pendingDelete.primaryLocale?.title || pendingDelete.document_key}"` : " this entry",
          "? This action cannot be undone."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { disabled: !!mutatingEntryId, className: "rounded-lg", children: "No" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogAction, { disabled: !!mutatingEntryId, onClick: (event) => {
          event.preventDefault();
          void confirmDeleteEntry();
        }, className: "rounded-lg bg-rose-600 text-white hover:bg-rose-700 focus-visible:ring-rose-300", children: [
          mutatingEntryId ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-1.5 h-4 w-4 animate-spin" }) : null,
          "Yes"
        ] })
      ] })
    ] }) })
